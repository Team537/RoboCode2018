...
public class AutoSwitch extends CommandGroup {
	public AutoSwitch(int location, boolean isSwitchLeft, double delay, boolean reversed) {
		...
		switch(location) {
			case 1: // Left.
				...
				addSequential(new CommandDriveRate(0.0, 0.6, 1.7)); // Forward 30cm.
				addSequential(new CommandDriveRate(270.0, 0.6, 2.8)); // Left 2m.
				break;
			case 2: // Centre.
			...
			case 3: // Right.
				...
				addSequential(new CommandDriveRate(0.0, 0.6, 1.7)); // Forward 30cm.
				addSequential(new CommandDriveRate(90.0, 0.6, 2.8)); // Right 2m.
				break;
			default:
	...
	//	addParallel(new CommandCollectSpeed(-0.7), 1.8);
		...
		//	addParallel(new CommandLiftSpeed(0.9), 2.0f);
			addSequential(new CommandDriveRate(0.0, 0.9, 1.2)); // Forward 90cm.
